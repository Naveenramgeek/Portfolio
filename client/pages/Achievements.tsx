...
export default function Achievements() {
  const achievements = [
    ...
    {
      title: "Built 4 End-to-End Applications",
      event: "Personal Portfolio",
      description:
        "Successfully developed and deployed 4 complete full-stack applications with CI/CD pipelines, AI integrations, and AWS cloud deployment.",
      prize: "Production Ready",
      icon: CodeIcon,
      color: "text-blue-600",
    ...
    },
    {
      ...
      event: "Software AG",
      description:
        "Promoted from Software Development Intern to Software Engineer I, then to Software Engineer II, demonstrating consistent growth and technical excellence.",
      prize: "Career Growth",
      icon: AwardIcon,
